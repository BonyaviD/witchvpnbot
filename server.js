...
const token = "5864011130:AAE1ETQGFRsiDHVzJKre1KU0zMdmwmNqxqA";
...
bot.onText(/\/start/, (msg) => {
  ...
  bot.on("message", (msg) => {
    if(msg.text == "email") bot.sendMessage(msg.chat.id, "به پنل خوش آمدید" ,
      {
        reply_markup: {
    ...
    else if(msg.text !== "/start" && msg.text !== "email" && msg.text !== "وضعیت اکانت" && msg.text !== "خرید" && 
    msg.text !== "آموزش" && msg.text !== "پشتیبانی" && msg.text !== "iOS" && msg.text !== "Windows" &&
    msg.text !== "Android" && msg.text !== "بازگشت" ) bot.sendMessage(msg.chat.id, "ایمیل یافت نشد")
